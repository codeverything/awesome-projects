...
class EarlyLateChargeService {
   ...
   * Create Role
   */
  public static async create(formData: EarlyLateHargaAttributes) {
   ...
   * Update Role By Id
   */
  public static async update(id: string, formData: EarlyLateHargaAttributes) {
...
export default EarlyLateChargeService
