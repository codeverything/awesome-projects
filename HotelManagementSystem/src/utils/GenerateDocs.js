...
const serverLocal = [
  {
    url: `http://localhost:${PORT || 8000}/v2`,
    description: 'Development server',
  },
  {
    url: 'https://api-nusa-hotel.ujiaplikasi.com/v2',
...
module.exports = function generateDocs(app) {
  ...
  const swaggerOptLocal = [
    {
      url: `http://localhost:${PORT || 8000}/v2/api-docs.json`,
      name: 'Development Server',
    },
    {
      url: 'https://api-nusa-hotel.ujiaplikasi.com/v2/api-docs.json',
      name: 'Staging Server',
    },
    {
      url: 'http://api.example.com/v1/api-docs.json',
  ...
  app.use('/v2/api-docs', swaggerUI.serve)
  app.get('/v2/api-docs', swaggerUI.setup(swaggerSpec, optionsSwaggerUI))
}
