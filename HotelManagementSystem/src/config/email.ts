...
class EmailProvider {
  ...
  public send = (
    ...
    // send an e-mail
    this.sendMail(dest, subject, text, emailConfig)
  }
  ...
  private setMailOptions = (
    ...
    const { fileName, pathToPdf } = emailConfig
    return {
  ...
  private sendMail = (
    ...
    this.mailConfig = isMailgunAPI
      ...
      : this.setMailConfig()
    this.mailOptions = this.setMailOptions(dest, subject, text, emailConfig)
