module.exports = {
            ...
            schema: {
              ...
              properties: {
                ...
                promoId: {
                  type: 'string',
                  format: 'uuid',
                  example: '8885b6e7-6b63-4e8f-bb98-da5661c68f51',
                },
              },
            },
          },
  ...
  '/check-kamar/{id}': {
    post: {
      tags: ['Reservasi Kamar'],
      summary: 'Pilih Reservasi Kamar yang akan Di Check',
      security: [
        {
          auth_token: [],
        },
      ...
      responses: {
        200: {
          description: 'Kamar Berhasil Di Cek',
        },
      },
    },
  },
