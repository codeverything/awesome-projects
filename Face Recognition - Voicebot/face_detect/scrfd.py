...
if __name__ == '__main__':
    ...
    detector = SCRFD(
        model_file='/home/khanhpluto/khanhtv/sharingan/insightface/detection/scrfd/onnx/scrfd_2.5g_bnkps_shape640x640.onnx')
    detector.prepare(-1)
    img_paths = ['/home/khanhpluto/Pictures/facial-recognition-768x512.jpg']
